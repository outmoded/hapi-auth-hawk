...
describe('Hawk', function () {
    ...
    it('returns a reply on successful auth', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            server.route({ method: 'POST', path: '/hawk', handler: function (request, reply) { reply('Success'); }, config: { auth: true } });
    ...
    it('returns a reply on failed optional auth', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkOptional', handler: function (request, reply) { reply('Success'); }, config: { auth: { mode: 'optional' } } });
    ...
    it('includes authorization header in response when the response is a stream', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkStream', handler: hawkStreamHandler, config: { auth: true } });
    ...
    it('includes valid authorization header in response when the request fails validation', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkValidate', handler: function (request, reply) { reply('Success'); }, config: { auth: true, validate: { query: {} } } });
    ...
    it('does not include authorization header in response when the response is an error', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkError', handler: function (request, reply) { reply(new Error()); }, config: { auth: true } });
    ...
    it('returns an error on insufficient tos', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkTos', handler: function (request, reply) { reply('Success'); }, config: { auth: { tos: '2.0.0' } } });
    ...
    it('returns an error on insufficient scope', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkScope', handler: function (request, reply) { reply('Success'); }, config: { auth: { scope: 'x' } } });
    ...
    it('returns a reply on successful auth and payload validation', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkPayload', handler: function (request, reply) { reply('Success'); }, config: { auth: { mode: 'required', payload: 'required' }, payload: { override: 'text/plain' } } });
    ...
    it('returns an error with payload validation when the payload is tampered with and the route has optional validation', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkPayloadOptional', handler: function (request, reply) { reply('Success'); }, config: { auth: { mode: 'required', payload: 'optional' }, payload: { override: 'text/plain' } } });
    ...
    it('returns a reply on successful auth and when payload validation is disabled', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkPayloadNone', handler: function (request, reply) { reply('Success'); }, config: { auth: { mode: 'required', payload: false }, payload: { override: 'text/plain' } } });
    ...
    it('returns a reply on successful auth when auth is optional and when payload validation is required', function (done) {
        ...
        server.pack.require('../', function (err) {
            ...
            expect(err).to.not.exist;
            server.auth.strategy('default', 'hawk', { getCredentialsFunc: getCredentials });
            server.route({ method: 'POST', path: '/hawkOptionalPayload', handler: function (request, reply) { reply('Success'); }, config: { auth: { mode: 'optional', payload: 'required' }, payload: { override: 'text/plain' } } });
